...
export const SCENES: LearningScene[] = [
  ...
  scene({
    ...
    summary: "Gentle kinship words with the same two Hello friends.",
  ...
  scene({
    ...
    summary: "House and home words — wetu clearing with the two Hello friends.",
