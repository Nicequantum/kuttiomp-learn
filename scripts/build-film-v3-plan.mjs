#!/usr/bin/env node
/**
 * Narrative-first shot plan for "One day" long film.
 * Fixed cast: Host + Guest only. 126 × 12s = 25m 12s.
 * Speakers map to cast; every shot has a visual beat + dialogue span.
 */
import { writeFileSync, mkdirSync } from "node:fs";
import { join } from "node:path";

const ROOT = "/workspace/artifacts/film-v3";
const SHOT_SEC = 12;
const SHOTS = 126;
const TOTAL = SHOT_SEC * SHOTS; // 1512

const STYLE =
  "Cinematic photoreal documentary-drama, respectful historical reconstruction of a coastal Southern New England Indigenous community, natural light, soft film grain, warm earth palette, no text, no logos, no modern objects, intimate 35mm look.";

/** Dialogue lines in narrative order (Narragansett + English). Speakers: Host | Guest | Both | Nature (no speech) */
const lines = [
  // —— 0 Dawn (Host wakes; Guest arrives later) ——
...
/**
 * Visual beats: 126 shots. cast: host | guest | both | nature
 * act groups for chapter markers in player
 */
const acts = [
  {
    id: "dawn",
    ...
    shots: [
      { cast: "nature", visual: "First grey-blue light over a coastal salt marsh at dawn, mist on still water reflecting the sky, long horizon of Southern New England coast." },
      { cast: "nature", visual: "Slow approach toward a birch-bark wetu dwelling among pines at the marsh edge, thin smoke rising from the roof hole, soft dawn." },
      { cast: "host", visual: "Inside the wetu, Host (elder man, grey hair, red-brown wrap) stirs awake on woven mats under furs, warm firelight on his face." },
      { cast: "host", visual: "Close-up: Host's hands carefully place dry wood on the low fire, sparks rise, intimate." },
      ...
      { cast: "host", visual: "Host outside the wetu, breathing the morning air, pines and marsh behind him." },
      { cast: "nature", visual: "Sun rising over pines and salt marsh, long golden rays across water." },
      { cast: "host", visual: "Host gathers a little more wood near the wetu, calm morning chore, same elder face and red-brown wrap." },
      { cast: "host", visual: "Host looks down the path toward the village clearing, waiting, gentle expression." },
      { cast: "nature", visual: "Wide village clearing waking — paths, dwellings, no people yet, morning birds." },
      { cast: "guest", visual: "Guest (younger man, black hair, brown wrap) walks the path toward the wetu from the marsh, morning light on his face." },
    ],
  },
  {
    id: "kin",
    ...
    shots: [
      { cast: "both", visual: "Host and Guest meet outside the wetu, Host greets with open hands, Guest bows head slightly, respectful morning greeting." },
      ...
      { cast: "both", visual: "Both men sit on mats outside the dwelling, calm conversation posture, same two faces only." },
      ...
      { cast: "both", visual: "Wide two-shot: Host and Guest standing side by side outside wetu, morning light, only these two people." },
      { cast: "host", visual: "Host places a hand over his heart in a respectful gesture of greeting." },
      { cast: "guest", visual: "Guest returns the respectful gesture, eyes kind." },
      { cast: "both", visual: "Both bow heads slightly toward each other, Cowaúnckamish moment, soft gold light." },
  ...
  },
  {
    ...
    shots: [
      ...
      { cast: "guest", visual: "Guest drinks water, relief, morning light." },
      { cast: "host", visual: "Host stirs soft corn porridge in a pot over the fire, gestures for Guest to stay and eat." },
      { cast: "both", visual: "Host serves Guest a bowl of porridge, hospitality, warm firelight." },
      ...
      { cast: "both", visual: "After the meal they stand, ready for the day's path, wipe hands, soft smile." },
    ],
  },
  {
    id: "path",
    ...
    shots: [
      ...
      { cast: "host", visual: "Host points to a broad trail — the great path — and then a shorter side way." },
      { cast: "both", visual: "They walk together a short stretch of dirt path under morning sun." },
      { cast: "nature", visual: "Forest-edge path, dappled green light through leaves, empty of people, breath of land." },
      { cast: "guest", visual: "Guest walks the path alone for a beat, thoughtful, same younger face and brown wrap." },
      { cast: "host", visual: "Host walks ahead as guide for a moment, grey hair, red-brown wrap." },
      ...
      { cast: "nature", visual: "Wind moves marsh grass and pine tops, fair weather sky." },
      { cast: "both", visual: "They continue together onto the broader trail toward the fields." },
      { cast: "guest", visual: "Guest counts on his fingers while walking — one, two — playful teaching moment." },
    ],
  },
  {
    id: "numbers",
    ...
    shots: [
      ...
      { cast: "both", visual: "Both laugh softly at the counting game, walking again toward fields." },
      { cast: "nature", visual: "Open garden plots appear ahead, spring green corn hills, sunny." },
    ],
  },
  {
    id: "land",
    ...
    shots: [
      ...
      { cast: "host", visual: "Host gathers a small heap of ripe ears into a basket (season collage sense of harvest)." },
  ...
  },
  {
    ...
    shots: [
      ...
      { cast: "host", visual: "Host moves carefully along the trail as if going to check traps, calm not violent." },
      ...
      { cast: "nature", visual: "Forest canopy, birds moving through branches, wings." },
      { cast: "both", visual: "They emerge from forest toward the water, salt air, open sky." },
    ],
  },
  {
    id: "water",
    title: "At the water",
    shots: [
      { cast: "nature", visual: "Coastal marsh shore, birchbark canoe on sand, water glittering." },
      ...
      { cast: "nature", visual: "Close water surface, fish shapes below, light on waves." },
      ...
      { cast: "both", visual: "They pull the canoe higher on shore and turn inland toward afternoon." },
    ],
  },
  {
    id: "sky",
    ...
    shots: [
      ...
      { cast: "nature", visual: "Wide sky, fair clouds over pines and marsh, late afternoon gold." },
      ...
      { cast: "nature", visual: "Sun lowering toward the horizon, Yahen wàiyàuw light." },
      ...
      { cast: "nature", visual: "The sun fully set, afterglow, silhouettes of pines." },
    ],
  },
  {
    id: "evening",
    ...
    shots: [
      ...
      { cast: "nature", visual: "Wetu silhouette, smoke, first stars beginning." },
  ...
  },
  {
    ...
    title: "Night return",
    shots: [
      { cast: "nature", visual: "Night sky over the marsh, bright moon Nanepaùshat, stars." },
      ...
      { cast: "nature", visual: "Exterior night: wetu, moon, still marsh." },
      { cast: "both", visual: "Final two-shot: Host and Guest at rest by embers, respectful closing." },
      { cast: "nature", visual: "Dawn light returns faintly on the same marsh — the day remembered, quiet close." },
    ],
  },
];

// Flatten shots and assign dialogue + timing
const flatShots = [];
let i = 0;
...
// Map dialogue lines evenly across full film timeline
...
// Attach nearest dialogue line id to each shot for generation context
  ...
  JSON.stringify(
    {
      ...
      lines: timedLines.map((l) => ({
        id: l.id.toLowerCase(),
        speaker: l.speaker === "Both" ? "Both" : l.speaker,
        narragansett: l.n,
        english: l.e,
        startSec: l.startSec,
        endSec: l.endSec,
